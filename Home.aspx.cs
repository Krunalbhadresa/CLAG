...
public partial class Home : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            //Request.Attributes["class"] = AddFooter.Attributes["class"].Replace("clsDspNone", "clsDspBlock");
    ...
    public void BindArticleTable()
    {
        try
        {
            ...
            {
                sb4.Append("<table class='table table-hover dt-responsive nowrap myTable' width='100%' id='WriterTable'>");
                sb4.Append("<thead>");
                sb4.Append("<tr><th></th>");
                sb4.Append("<th>ArticleTitle</th>");
                sb4.Append("<th>Writer</th>");
               
                sb4.Append("<th scope='col'>View</th>");
                


                sb4.Append("</tr>");
                sb4.Append("</thead><tbody>");


                for (int i = 0; i < ds4.Tables[0].Rows.Count; i++)
                {
                    sb4.Append("<tr>");
                    sb4.Append("<td>" + Convert.ToString(i + 1) + "</td>");
                    sb4.Append("<td class='ArticleTitle'>" + Convert.ToString(ds4.Tables[0].Rows[i]["ArticleTitle"]) + "</td>");
                    sb4.Append("<td class='WriterMediumUName'>" + Convert.ToString(ds4.Tables[0].Rows[i]["WriterName"]) + "</td>");
                    sb4.Append("<td class='ArticleStatus'>" + Convert.ToString(ds4.Tables[0].Rows[i]["Status"]) + "</td>");

                    sb4.Append("<td><button type='button' class='btnViewArticle' ArticleId='" + Convert.ToString(ds4.Tables[0].Rows[i]["ArticleId"]) + "'>View</button></td>");
                    //sb1.Append("<td><button type='button' class='btnUpdate' ReviewerId='" + Convert.ToString(ds1.Tables[0].Rows[i]["Id"]) + "'>Update</button></td>");
                    //sb1.Append("<td><button type='button' class='btnDelete' ReviewerId='" + Convert.ToString(ds1.Tables[0].Rows[i]["Id"]) + "'>Delete</button></td>");

                    sb4.Append("</tr>");
                }
                sb4.Append("</tbody></table>");
                divArticleGrid.InnerHtml = Convert.ToString(sb4);
            }
            else
            {
                Response.Write("NO DATA FOUND");

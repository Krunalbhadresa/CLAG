    ...
    <section id="portfolio" class="mt-5">
        <div class="container">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active"  href="#Requests" role="tab" data-toggle="tab"> Writer Requests</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#Writer" role="tab" data-toggle="tab">Writers</a>
                </li>
                 <li class="nav-item">
                    <a class="nav-link" href="#Article" role="tab" data-toggle="tab">Article Requests</a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane fade in" id="Writer">
                  ...
                  <div role="tabpanel" class="tab-pane fade in" id="Article">

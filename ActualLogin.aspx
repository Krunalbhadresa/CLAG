<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ActualLogin.aspx.cs" Inherits="ActualLogin" %>
...
<body>
    <form id="form1" runat="server">
      ...
      <div class="container">
            ...
            <h2 class="section-heading mb-2" style="color:white">LOGIN</h2>
          ...
          <div class="form-inline mt-5">
              ...
              <div class="row w-100" style="margin-right: 0px; margin-left: 0px;">
                  ...
                  <div class="input-group w-100 mb-4">
                      ...
                      <asp:TextBox type="password" ID="txtpwd" class="form-control input-md" placeholder="Password" runat="server" />
                  </div>
              </div>


          </div>
             <asp:Button ID="btnLogin" class="btn btn-outline-secondary" style="border:2px solid white; color:white;" runat="server" OnClick="btnLogin_Click" Text="Login" />
             <asp:Button ID="btnForgotPwd" class="btn btn-outline-secondary" style="border:2px solid white; color:white;" runat="server" OnClick="btnForgotPwd_Click" Text="Forgot Password?" />
          <br />
          <br />

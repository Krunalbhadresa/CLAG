<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ArticleEditor.aspx.cs" Inherits="ArticleEditor" %>
...
<body>
    ...
    <section class="content-section-b" style="height:100vh;  padding-top:15vh; background-color:white; background: none;">
      <div class="container">
            ...
            <%--<h2 class="section-heading mb-4" style="color:black">ADD EDITOR</h2>--%>
           
                    <div class="row w-100 mt-5" style="margin-right: 0px; margin-left: 0px;">
                        <label class="sr-only" for="txtEditorName">Name</label>
                        <div class="input-group w-100 mb-1" >
                          <div class="input-group-addon">Name</div>
                         <asp:TextBox type="text" ID="txtEditorName" class="form-control input-md" placeholder="Jane Doe" runat="server" />
                        </div>
                    <%--</div>
                
                    <div class="form-inline mt-5" style="color:black">--%>
                        <div class="row w-100" style="margin-right: 0px; margin-left: 0px;">
                            <label class="sr-only" for="txtEditorEmail">Email id</label>
                            <div class="input-group w-100 mb-1" >
                              <div class="input-group-addon">Email address</div>
                             <asp:TextBox type="text" ID="txtEditorEmail" class="form-control input-md" placeholder="you@example.com" runat="server" />
                            </div>
                        </div>
                        <br />
                        ...
                        <div id="AddFooter" runat="server" class="col-12 w-100 mb-4 text-center clsDspNone" style="margin-right: 0px; margin-left: 0px; margin-top:6vh;">
                            <asp:Button type="button" ID="btnEditorAdd" class="btn btn-outline-secondary" style="border:2px solid black; background-color:transparent; color:black; margin-right:10px;" runat="server" OnClick="btnSubmit_Click" Text="Add" />
                            <asp:Button ID="btnCancel" class="btn btn-outline-secondary" style="border:2px solid black;  background-color:transparent; color:black;" runat="server" OnClick="btnCancel_Click" Text="Cancel" />
                        </div>

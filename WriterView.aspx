<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WriterView.aspx.cs" Inherits="WriterView" %>
            ...
            <h2 class="section-heading mb-4" style="color:black">VIEW REQUEST</h2>
                    ...
                    <div class="row w-100 mt-5" style="margin-right: 0px; margin-left: 0px;">
                        ...
                        <div id="ViewFooter" runat="server" class="col-12 w-100 mb-4 text-center clsDspNone" style="margin-right: 0px; margin-left: 0px; margin-top:6vh;">
                            <asp:Button type="button" ID="btnProEditor" class="btn btn-outline-secondary" style="border:2px solid black; background-color:transparent; color:black; margin-right:10px;" runat="server" OnClick="btnProEditor_Click" Text="Promote to Editor" />
                            <asp:Button type="button" ID="btnProReviwer" class="btn btn-outline-secondary" style="border:2px solid black; background-color:transparent; color:black; margin-right:10px;" runat="server" OnClick="btnProReviwer_Click" Text="Promote to Reviewer" />
                            <asp:Button  type="button" ID="btnCancel" class="btn btn-outline-secondary" style="border:2px solid black;  background-color:transparent; color:black;" runat="server" OnClick="btnCancel_Click" Text="Cancel," />
                        </div>

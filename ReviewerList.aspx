<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReviewerList.aspx.cs" Inherits="ReviewerList"  %>
...
<body>  <!-- Navigation -->
    ...
    <form id="form1" runat="server"  style="margin-top:15vh;">
       ...
       <div class="container mt-3">
        <asp:Button ID="AddReviewer" class="btn btn-primary mb-3 ml-3 btn-lg btnAddReviewer" runat="server" OnClick="AddReviewer_Click"  Text="Add Reviewer"></asp:Button>

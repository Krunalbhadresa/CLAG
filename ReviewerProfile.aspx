<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReviewerProfile.aspx.cs" Inherits="ReviewerProfile" %>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="Editor.aspx">Dashboard</a>
            </li>                      
              <li class="nav-item">
